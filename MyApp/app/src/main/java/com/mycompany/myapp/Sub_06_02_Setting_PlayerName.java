...
public class Sub_06_02_Setting_PlayerName extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
		...
		topTextview.setText(R.string.sub_06_02_title);
		...
		return_button.setOnClickListener(new OnClickListener(){
				public void onClick(View v){
					//seni
					Intent intent = new Intent(getApplication(), Sub_06_01_Setting_PlayerNum.class);
					startActivity(intent);
				}
			});
